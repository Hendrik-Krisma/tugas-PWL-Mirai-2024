<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo "./dashboard.php?section=ordersPage"; ?>">
        <div
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo "./dashboard.php?section=invoicesPage"; ?>">
        <div
          class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <span class="nav-link-text ms-1">Order Invoices</span>
      </a>
    </li>
